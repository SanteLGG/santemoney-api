...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
    ...
    private Predicate[] criarRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder, Root<Lancamento> root) {
        ...
        if (lancamentoFilter.getDataVencimentoAte() != null){
            predicates.add(builder.lessThanOrEqualTo(root.get("dataVencimemto"), lancamentoFilter.getDataVencimentoAte()));
        }
    ...
    private void adicionarRestricoesDePaginacao(TypedQuery<Lancamento> query, Pageable pageable) {
        ...
        int totalRegistroPorPagia = pageable.getPageSize();
        int primieroRegistroDaPagina = paginaAtual * totalRegistroPorPagia;

        query.setFirstResult(primieroRegistroDaPagina);
        query.setMaxResults(totalRegistroPorPagia);
    }
